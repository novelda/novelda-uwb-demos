...
from Presence2DPlotter_plotter import Presence2DPlotter

def main_loop(sharedmem: SharedMemReceiver, plotter: Presence2DPlotter,
...
if __name__ == "__main__":
    ...
    plotter = Presence2DPlotter(shm_on_exit=sharedmem.cleanup)
    plotter.init_window()
