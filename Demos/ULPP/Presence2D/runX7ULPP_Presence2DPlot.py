...
def run_with_setup(setup_json: str):
    ...
    liveflow_fp = str(Path(__file__).resolve().parent / "Flows" / "ULPP_Presence2D_LiveBA22Plot_Python.sfl") 
    playbackflow_fp = str(Path(__file__).resolve().parent / "Flows" / "ULPP_Presence2D_PlaybackBA22Plot_Python.sfl")
    ...
    print("Running X7 ULPP Presence2D with preset: ", setup_json)
